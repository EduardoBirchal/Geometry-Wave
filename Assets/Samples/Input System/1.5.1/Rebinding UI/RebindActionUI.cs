    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .WithCancelingThrough("<Keyboard>/c")
                //<Keyboard>/escape  
                .OnCancel(
                    operation =>
                    {
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if(CheckDuplicateBidings(action, bindingIndex, allCompositeParts) == true){
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool CheckDuplicateBidings(InputAction action, int bindingIndex, bool allCompositeParts = false){
            ...
            foreach (InputBinding binding in action.actionMap.bindings){
                ...
                if(binding.effectivePath == newBinding.effectivePath){
                    Debug.Log("repeated binding found: " + newBinding.effectivePath);
                    return true;
                }
            }
